    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                Section::make(__('filament.resources.posts.sections.post_overview'))
                    ->description(__('filament.resources.posts.sections.post_overview_desc'))
                    ...
                    ->schema([
                        ...
                        IconEntry::make('is_published')
                            ->label(__('filament.resources.posts.fields.status'))
                            ->boolean()
                        ...
                        TextEntry::make('slug')
                            ...
                            ->copyable()
                            ->copyMessage(__('filament.resources.posts.messages.copied'))
                ...
                // Content Section
                Section::make(__('filament.resources.posts.sections.content'))
                    ->description(__('filament.resources.posts.sections.content_desc'))
                ...
                // Media Section
                Section::make(__('filament.resources.posts.sections.media'))
                    ->description(__('filament.resources.posts.sections.media_desc'))
                ...
                Section::make(__('filament.resources.posts.sections.seo_info'))
                    ->description(__('filament.resources.posts.sections.seo_info_desc'))
                ...
                Section::make(__('filament.resources.posts.sections.publish_info'))
                    ->description(__('filament.resources.posts.sections.publish_info_desc'))
                ...
                Section::make(__('filament.resources.posts.sections.system_info'))
                    ->description(__('filament.resources.posts.sections.system_info_desc'))
                    ->icon('heroicon-o-computer-desktop')
                    ->columns(3)
                    ->collapsed()
                    ->schema([
                        TextEntry::make('id')
                            ->label(__('filament.resources.posts.fields.id'))
                            ->badge()
                            ->color('gray')
